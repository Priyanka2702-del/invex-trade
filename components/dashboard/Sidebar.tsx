...
className={`mb-4 flex items-center gap-3 rounded-lg bg-blue/10 px-3 py-2.5 text-sm font-semibold text-blue transition hover:bg-blue/20 ${          collapsed ? "justify-center" : ""
        }`}
      ...
      <nav className="flex flex-1 flex-col gap-0.5 overflow-y-auto">
        {mainLinks.map((l) => (
          <Link
            ...
            href={l.href}
            className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
isActive(l.href) ? "bg-blue/10 text-blue" : "text-steel hover:bg-paper hover:text-ink"            } ${collapsed ? "justify-center" : ""}`}
