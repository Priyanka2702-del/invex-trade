...
className="rounded-lg bg-blue/10 px-4 py-2 text-sm font-semibold text-blue transition hover:bg-blue/20"        >
          Deposit
        </Link>
        ...
        <div className="relative">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-line bg-white p-0.5 text-blue"
          >
