  ...
  return (
    <div>
      <div className="mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        ...
        <Link
          href="/open-account"
className="flex shrink-0 items-center justify-center gap-2 rounded-lg bg-blue/10 px-4 py-2.5 text-sm font-semibold text-blue transition hover:bg-blue/20"        >
...
className="flex items-center gap-1.5 rounded-lg bg-blue/10 px-3.5 py-2 text-sm font-medium text-blue transition hover:bg-blue/20"              >
                Trade
              </Link>
            </div>
          </div>
