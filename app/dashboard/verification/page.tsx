    ...
    <div>
      ...
      <div className="rounded-xl border border-line bg-white p-6">
        ...
        <button
          type="button"
          disabled={!fileName}
          className="mt-4 w-full rounded-lg bg-blue py-3 text-sm font-semibold text-white transition hover:bg-blue-deep disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto sm:px-8"
        >
          Submit for Review
        </button>
      </div>
