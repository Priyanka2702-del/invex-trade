    ...
    <div>
      <div className="mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="flex shrink-0 items-center justify-center gap-2 rounded-lg bg-blue px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-deep"
        >
          <TrendingUp size={16} />
          Invest Now
        </button>
