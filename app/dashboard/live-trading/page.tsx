        ...
        {MT5_WEBTRADER_URL ? (
          <>
            <p className="mx-auto mt-2 max-w-md text-sm text-steel">
              You&apos;re about to open the MT5 WebTrader in a new tab to place
              live trades.
            </p>
          ...
          <>
            ...
            <div className="mx-auto mt-6 max-w-md rounded-lg bg-paper px-4 py-3 text-left text-xs text-steel">
              For developers: set{" "}
              <code className="rounded bg-line/60 px-1 py-0.5 font-mono">
                NEXT_PUBLIC_MT5_WEBTRADER_URL
              </code>{" "}
              once a real MT5 WebTrader URL is issued — this page will link out
              to it automatically.
            </div>
          </>
        )}
